...
<div class="col-xs-12">
    <section>
        <ol style="margin-bottom: 5px;" class="breadcrumb">
            ...
            <li><a href="#">{{$infoDapil->nama_dapil}}</a></li>
        </ol>
     </section>
</div>
                ...
                <table class="display table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id_calon="{{$calon->id_calon}}" placeholder="0" min="0" class="form-control suara_calon" onkeydown="return validasi_number(event)" disabled value="{{$calon->hitungSuaraByDapil($calon->id_calon,$infoDapil->id_dapil)}}">
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
