...
<div class="col-xs-12">
    <section>
        <ol style="margin-bottom: 5px;" class="breadcrumb">
            ...
            <li><a href="#">Pemungutan Suara Partai</a></li>
                ...
                <table class="display table">
                    ...
                    <tbody>
                        <tr>
                            <td>Jumlah Suara</td>
                            <td>
                                <input type="number" id_partai="{{$data->id_partai}}" placeholder="0" min="0" class="form-control suara_calon" onkeydown="return validasi_number(event)">
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<script type="text/javascript">
    ...
    function doSubmit() {
        ...
        $.ajax({
            url    : "{{Route('api')}}/submit/data_suara_partai",
            method : "POST",
            data   : {
            ...
            success: function(res) {
                ...
                if(res.success) {
                    ...
                    redirect("{{Route('pemungutan_suara_partai.index')}}",3000);
                } else
