...
<form action="{{Route('dapil.update',$data->id_dapil)}}" method="POST">
{{csrf_field()}}
{{method_field('PATCH')}}
<div class="col-xs-12">
    <div class="sec-box">
        ...
        <header>
            <h2 class="heading">Form Pembaharuan Dapil</h2>
        </header>
        <div class="contents">
                ...
                <table class="display table" id="tabel-user">
                    ...
                    <tbody>
                    	<tr>
                    		<td>Nama Dapil</td>
                    		<td>
                    			<input type="text" name="nama_dapil" value="{{$data->nama_dapil}}" placeholder="Contoh: Dapil-001" class="form-control" id="nama_dapil">
                    		</td>
                    	</tr>
                    </tbody>
                </table>
